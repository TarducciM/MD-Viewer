...
const it: Dict = {
  ...
  "menu.panelSide": "Pannelli a sinistra",
  "menu.theme": "Tema",
  "menu.settings": "Impostazioni…",
  "menu.commandPalette": "Palette comandi… (Ctrl+Shift+P)",
...
const en: Dict = {
  ...
  "menu.window": "Window",
  "menu.panelSide": "Panels on the left",
  "menu.theme": "Theme",
  "menu.settings": "Settings…",
  "menu.commandPalette": "Command Palette… (Ctrl+Shift+P)",
